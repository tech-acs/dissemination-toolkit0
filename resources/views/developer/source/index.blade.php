<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <p class="mt-2 max-w-7xl text-sm text-gray-500">
            {{ __('All your sources and their database connections should be configured ') }}
        </p>
    </x-slot>
                        ...
                        @forelse($records as $record)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    @endif
                                    <a href="{{route('manage.developer.childsource.edit', $record->id)}}" class="text-indigo-600 hover:text-indigo-900">{{ __('Edit') }}</a>
                                    <span class="text-gray-400 px-1">|</span>
