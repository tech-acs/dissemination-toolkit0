    ...
    <div class="flex flex-col  max-w-7xl mx-auto py-23 sm:px-6 lg:px-8">
        ...
        <ul role="list" class="mt-6 grid grid-cols-1 gap-6  sm:grid-cols-2">
            <li class="flow-root py-2">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 hover:border hover:border-green-800">
            ...
            <li class="flow-root py-2">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 hover:border hover:border-yellow-800">
            ...
            <li class="flow-root py-2">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 hover:border hover:border-red-800">
            ...
            <li class="flow-root py-2">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500  hover:bg-gray-50 hover:border hover:border-blue-800">
            ...
            <li class="flow-root py-2">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 hover:border hover:border-indigo-800">
            ...
            <li class="flow-root py-2">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 hover:border hover:border-pink-800">
            ...
            <li class="flow-root py-2">
                <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 hover:border hover:border-sky-800">
