<div class="shadow sm:rounded-md sm:overflow-hidden">
        ...
        <div class="grid grid-cols-1 gap-6 pl-3 md:pl-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <x-input id="title" name="title" class="mt-1 block w-full" value="{{old('title', $dataSource->title ?? null)}}" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div>
                    <x-label for="case_stats_component" value="{!! __('Case stats component') !!}" class="inline" />
    ...
    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
        <x-secondary-button class="mr-2"><a href="{{ route('manage.data-source.index') }}">{{ __('Cancel') }}</a></x-secondary-button>
        <x-button>
            {{ __('Submit') }}
        </x-button>
    </div>
