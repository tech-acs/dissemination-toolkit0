    ...
    <div class="col-span-2">
        ...
        <div class="" x-data="{expanded: false}">
            ...
            <div class="relative">
                ...
                <div class="relative flex justify-center" x-show="! expanded">
                    <button x-on:click="expanded = true" type="button" class="inline-flex items-center gap-x-1.5 rounded-full bg-white px-3 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
            ...
            <div x-show="expanded" class="pt-8">
                @foreach($subject->reviews ?? [1, 2] as $review)
                    <article class="">
                        ...
                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Found it very informative!</h3>
