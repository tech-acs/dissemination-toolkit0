...
class MapWizardController extends Controller
{
    ...
    public function step2()
    {
        ...
        //dump($resource);
        return view('manage.viz-builder.map.step2')->with(['steps' => $this->steps, 'currentStep' => $step, 'resource' => $resource, 'options' => $options]);
    }
    ...
    public function edit(int $visualizationId)
    {
        ...
        $resource = session()->get('viz-wizard-resource');
        return view('manage.viz-builder.map.step2')->with(['steps' => $this->steps, 'currentStep' => $step, 'resource' => $resource]);
    }
